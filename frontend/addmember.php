                            ...
                            <div class="col-md-6">
                                <div class="profile-edit-container">
                                    ...
                                    <div class="custom-form">
                                        ...
                                        <input type="text" placeholder="KylianDev" value=""/>
                                        <label>Adresse Email<i class="fa fa-envelope"></i> </label>
                                        <input type="text" placeholder="me@kyliandev.fr" value=""/>
                                        ...
                                        <button type="submit" class="btn big-btn color-bg flat-btn">Valider la création
